...
> | N | A ledger row jumps to the brightest sample with the peak focused (the chart's click-through, shared), and the sample browser shows each sample's assignment status | this step |
>
